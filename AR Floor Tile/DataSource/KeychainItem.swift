...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "Wisdom.AR-Floor-Tile", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "Wisdom.AR-Floor-Tile", account: "userIdentifier").deleteItem()
        } catch {
